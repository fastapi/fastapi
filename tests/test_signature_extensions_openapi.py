        ...
        "schemas": {
            ...
            "Schema_1": {
                "properties": {
                    ...
                    "schema_1_param_2": {"title": "Schema 1 Param 2", "type": "string"},
                },
                "required": ["schema_1_param_1", "schema_1_param_2"],
                "title": "Schema_1",
                "type": "object",
            },
            "Body_endpoint_1_test_1_get": {
                "properties": {
                    "extra_param_schema_1": {"$ref": "#/components/schemas/Schema_1"},
                    "extra_param_body": {
                        "default": "aaa",
