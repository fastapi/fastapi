...
def test_required_field_alias_model_by_name():
    ...
    # AssertionError: assert 'Input should be a valid bytes' == 'Field required'
...
def test_required_field_alias_model_by_alias():
    ...
    # {"detail":[{"type":"missing","loc":["body","file"],"msg":"Field required","input":{"file_alias":"content"}}]}
...
def test_optional_field_alias_model_by_name():
    ...
    # Currently fails due to issue with aliases:
    # AssertionError: assert 422 == 200
    # {"detail":[{"type":"bytes_type","loc":["body","file"],"msg":"Input should be a valid bytes","input":{"filename":"upload","file":{"_file":{},"_max_size":1048576,"_rolled":false,"_TemporaryFileArgs":{"mode":"w+b","buffering":-1,"suffix":null,"prefix":null,"encoding":null,"newline":null,"dir":null,"errors":null}},"size":7,"headers":{"content-disposition":"form-data; name=\"file\"; filename=\"upload\"","content-type":"application/octet-stream"},"_max_mem_size":1048576}}]}
...
def test_list_field_alias_model_by_alias():
    ...
    # Currently fails due to issue with aliases:
    # AssertionError: assert 422 == 200
    # {"detail":[{"type":"missing","loc":["body","files"],"msg":"Field required","input":{"files_alias":["content1","content2"]}}]}
...
def test_list_field_alias_model_schema():
    ...
    # {'files_alias': {'items': {'type': 'string', 'format': 'binary'}, 'title': 'Files Alias', 'type': 'array'}}
...
# Current situation: validation doesn't work, but schema generation works
