...
async def solve_dependencies(
    *,
    ...
    dependant: Dependant,
    body: dict[str, Any] | FormData | bytes | UndefinedType | None = None,
...
async def request_body_to_args(
    body_fields: list[ModelField],
    received_body: dict[str, Any] | FormData | bytes | UndefinedType | None,
    embed_body_fields: bool,
    ...
    for field in body_fields:
        ...
        if (
            body_to_process is not None
            and not isinstance(body_to_process, UndefinedType)
            and not isinstance(body_to_process, bytes)
        ):
            try:
