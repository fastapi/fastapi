    ...
    def _iter(self):
        ...
        while True:
            ...
            if freq == YEARLY:
                ...
                valid = False
                rep_rate = 24 * 60
                for _j in range(rep_rate // gcd(interval, rep_rate)):
                    if byminute:
                ...
                rep_rate = 24 * 3600
                valid = False
                for _j in range(0, rep_rate // gcd(interval, rep_rate)):
                    if bysecond:
...
class _rrulestr(object):
    ...
    def _parse_rfc(
        ...
        TZID_NAMES = {x.upper(): x for x in re.findall("TZID=(?P<name>[^:]+):", s)}
        s = s.upper()
        if not s.strip():
