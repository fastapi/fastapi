...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "declarations": [
            ...
            (
                r"\b(package)(\s+)(object)\b(\s*)%s(%s)?" % (notStartOfComment, anyId),
            ...
            (r"\b(given)\b(\s*)(%s)?" % anyId, bygroups(Keyword, Whitespace, Name)),
        ],
        "inheritance": [
            (
        ...
        "inline": [
            ...
            # match or parameters.
            (r"\b(inline)(?=\s+(%s|%s)\s*:)" % (plainid, backQuotedId), Keyword),
        ...
        "interpolated-string-common": [
            (r'[^"$\\]+', String),
            (r"\$\$", String.Escape),
            (r"(\$)(%s)" % simpleInterpolatedVariable, bygroups(String.Interpol, Name)),
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    using(this, state="modifiers"), Keyword.Declaration, Whitespace
                ),
                "class",
            ),
            # Variables
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(print|println|readln|raise|fun" r"|asInterfaceInstance)\b",
                Name.Builtin,
            ),
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        "default": [
            ...
            (
                r"-?(\d+\.\d*|\.\d+)([eE][-+]?\d+)?[fFdD]?"
                r"[\x00-\x08\x0b\x0c\x0e-\x1f]*%s" % _break,
                Number.Float,
            ),
            ...
            (r"(\.end|\.limit|use)%s" % _break, Keyword.Reserved, "no-verification"),
            ...
            (r"is%s" % _break, Keyword.Reserved, ("descriptor/convert-dots", "var")),
            ...
            (
                ...
                r"static|virtual)%s" % _break,
                Keyword.Reserved,
                "invocation",
            ),
            (
                r"(getfield|putfield)%s" % _break,
                Keyword.Reserved,
                ("descriptor/no-dots", "field"),
            ),
            (
                r"(getstatic|putstatic)%s" % _break,
                Keyword.Reserved,
            ...
            (
                r"(multianewarray|newarray)%s" % _break,
                Keyword.Reserved,
        ...
        "annotation": [
            ...
            (r"default%s" % _break, Keyword.Reserved, ("#pop", "annotation-default")),
            include("default"),
        ],
        "annotation-body": [
            (r"\n+", Whitespace),
        ...
        "class/convert-dots": [
            ...
            (
                ...
                bygroups(Name.Namespace, Name.Class),
                "#pop",
            ),
        ],
        "class/no-dots": [
        ...
        "exception": [
            ...
            (
                r"((?:%s[/.])*)(%s)" % (_unqualified_name, _name),
                bygroups(Name.Namespace, Name.Exception),
                "#pop",
            ),
        ],
        "field": [
        ...
        "verification": [
            include("default"),
            (
                r"(Double|Float|Integer|Long|Null|Top|UninitializedThis)%s" % _break,
                Keyword,
                "#pop",
            ),
