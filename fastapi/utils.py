...
def get_model_definitions(*, 
                          ...
                          model_name_map: Dict[Union[Type[BaseModel], Type[Enum]], str], ) -> Dict[str, Any]:
...
def create_response_field(name: str, 
    ...
    response_field = functools.partial(ModelField, 
                                       name=name, 
                                       type_=type_, 
...
def create_cloned_field(field: ModelField, 
                        *, 
                        cloned_types: Optional[Dict[Type[BaseModel], Type[BaseModel]]] = None, ) -> ModelField:
...
def generate_operation_id_for_path(*, name: str, path: str, method: str) -> str:  # pragma: nocover
    warnings.warn("fastapi.utils.generate_operation_id_for_path() was deprecated, " 
...
def get_value_or_default(first_item: Union[DefaultPlaceholder, DefaultType], 
                         *extra_items: Union[DefaultPlaceholder, DefaultType], ) -> Union[DefaultPlaceholder, DefaultType]:
    """
