...
class FastAPI(Starlette):
    ...
    def openapi(self) -> Dict[str, Any]:
        if not self.openapi_schema:
            self.openapi_schema = get_openapi(title=self.title, 
    ...
    def setup(self) -> None:
        ...
        if self.openapi_url and self.docs_url:
            ...
            if self.swagger_ui_oauth2_redirect_url:
                ...
                self.add_route(self.swagger_ui_oauth2_redirect_url, 
                               swagger_ui_redirect, 
    ...
    def add_api_route(self, 
                      ...
                      *, 
                      ...
                      generate_unique_id_function: Callable[[routing.APIRoute], str] = Default(generate_unique_id), ) -> None:
    ...
    def api_route(self, 
                  ...
                  *, 
                  ...
                  name: Optional[str] = None, 
                  openapi_extra: Optional[Dict[str, Any]] = None, 
                  generate_unique_id_function: Callable[[routing.APIRoute], str] = Default(generate_unique_id), ) -> Callable[[DecoratedCallable], DecoratedCallable]:
