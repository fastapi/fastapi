...
Pero toda esta funcionalidad de usar código asincrónico con `async` y `await` se resume muchas veces como el uso de "coroutines". Es comparable a la característica principal de Go, las "Goroutines".
