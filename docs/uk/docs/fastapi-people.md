# Люди, що внесли свій вклад у розвиток FastAPI
...
Вони надали вихідний код, документацію, переклади тощо. 📦
...
Я також залишаю за собою право оновлювати алгоритм, розділи, пороги тощо (про всяк випадок 🤷).
