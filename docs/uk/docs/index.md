...
* **Швидке кодування**: Збільшить швидкість розробки функціоналу приблизно на 200%-300%. *
...
Таким чином, ви оголошуєте **один раз**, як параметри функції, типи параметрів, тіло, тощо.
...
* Перевірка даних:
    ...
    * Перевірка для JSON в високим рівнем вкладеності.
...
* Документує все за допомогою OpenAPI, та використано в:
...
* Дуже потужна і проста у використанні система **<abbr title="також відома як: components, resources, providers, services, injectables">Ін'єкція Залежностей</abbr>** system.
