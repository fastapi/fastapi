...
> 이 프로젝트의 역사가 궁금합니다. 몇 주 만에 멋진 결과를 낸 것 같아요. [...]

여기 그 역사에 대해 간단히 설명합니다.
...
>
> 저는 오랫동안 새로운 프레임워크를 만드는 것을 피하고자 했습니다. **FastAPI**가 제공하는 기능들을 다양한 프레임워크와 플러그인, 도구들을 조합해 해결하려 했습니다.
>
...
이 과정을 통해 코드 중복을 최소화하고, 모든 곳에서 자동 완성, 타입 검사, 에러 확인 기능이 제공되는 최적의 방식을 찾아냈습니다. 이 모든 것은 개발자들에게 최고의 개발 경험을 제공하기 위해 설계되었습니다.
...
또한, 또 다른 주요 요구사항이었던 [Starlette](https://www.starlette.io/)에도 기여했습니다.

---

## 개발

**FastAPI**를 개발하기 시작할 즈음에는 대부분의 준비가 이미 완료된 상태였습니다. 설계가 정의되었고, 요구사항과 도구가 준비되었으며, 표준과 명세에 대한 지식도 충분했습니다.
