...
- 아주 인상적인 성능. 이는 <a href="https://github.com/encode/starlette#performance" class="external-link" target="_blank">**Node.JS**와 **Go**와 동등하게 사용 가능한 가장 빠른 파이썬 프레임워크 중 하나입니다</a>.
- **WebSocket** 지원.
- 프로세스 내의 백그라운드 작업.
- 시작과 종료 이벤트.
- HTTPX 기반 테스트 클라이언트.
