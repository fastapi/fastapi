...
To see all the options you have, checkout the docs for <a href="https://docs.pydantic.dev/usage/types/" class="external-link" target="_blank">Pydantic's exotic types</a>. You will see some examples in the next chapter.
