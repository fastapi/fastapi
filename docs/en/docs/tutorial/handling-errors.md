...
`RequestValidationError` is a sub-class of Pydantic's <a href="https://docs.pydantic.dev/usage/models/#error-handling" class="external-link" target="_blank">`ValidationError`</a>.
