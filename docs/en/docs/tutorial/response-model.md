...
!!! info
    FastAPI uses Pydantic model's `.dict()` with <a href="https://docs.pydantic.dev/usage/exporting_models/#modeldict" class="external-link" target="_blank">its `exclude_unset` parameter</a> to achieve this.
...
!!! info
    ...
    * `response_model_exclude_none=True`
    ...
    as described in <a href="https://docs.pydantic.dev/usage/exporting_models/#modeldict" class="external-link" target="_blank">the Pydantic docs</a> for `exclude_defaults` and `exclude_none`.
