...
That way, you can create a token with an expiration of, let's say, 1 week. And then when the user comes back the next day with the token, you know they are still logged in to your system.
