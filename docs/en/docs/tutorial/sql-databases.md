...
{* ../../docs_src/sql_databases/tutorial001_an_py310.py ln[33:40] hl[33:37] *}

Here we create the tables in a lifespan function.
...
{* ../../docs_src/sql_databases/tutorial002_an_py310.py ln[60:66] hl[60:66] *}
...
{* ../../docs_src/sql_databases/tutorial002_an_py310.py ln[69:76] hl[69] *}

### Read One Hero with `HeroPublic` { #read-one-hero-with-heropublic }

We can **read** a single hero:

{* ../../docs_src/sql_databases/tutorial002_an_py310.py ln[79:84] hl[81] *}
...
{* ../../docs_src/sql_databases/tutorial002_an_py310.py ln[87:97] hl[87:88,92:93] *}
