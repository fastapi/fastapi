...
!!! info "Info"
    If you need to connect to your relational database asynchronously, see ([Async SQL (Relational) Databases](../advanced/async-sql-databases.md){.internal-link target=_blank}) for details.
