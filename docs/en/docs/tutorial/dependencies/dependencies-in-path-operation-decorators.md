...
!!! info
    If you declare a dependency on `Response`, you will get an empty response that you can modify, but this may not be the same response that is returned to your client if your path operation returns a different response.
