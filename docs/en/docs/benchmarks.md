...
Independent TechEmpower benchmarks show **FastAPI** applications running among Uvicorn and Starlette (used internally by FastAPI) as <a href="https://www.techempower.com/benchmarks/#section=test&runid=7464e520-0dc2-473d-bd34-dbdfd7e85911&hw=ph&test=query&l=zijzen-7" class="external-link" target="_blank">one of the fastest Python frameworks available</a>.
