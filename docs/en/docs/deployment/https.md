...
You would probably get a cloud server (a virtual machine) or something similar, and it would have a <dfn title="That doesn't change">fixed</dfn> **public IP address**.
