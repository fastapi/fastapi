...
<p align="center">
    <em>FastAPI фреймворк, өндөр гүйцэтгэлтэй, сурахад хялбар, хурдан кодлох боломжтой, бүтээгдэхүүнд бэлэн</em>
</p>
<p align="center">
...
FastAPI нь стандарт Python тайп хинт(1) дээр суурилсан, API хөгжүүлэх зориулалттай, орчин үеийн, хурдан (өндөр гүйцэтгэлтэй) вэб фреймворк юм.
{ .annotate }
...
* **Хурдан**: **NodeJS** болон **Go**-тэй адилхан түвшний маш хурдан гүйцэтгэлтэй (Starlette ба Pydantic-ийн ачаар). [Хамгийн хурдан Python фреймворкийн нэг](#_11).
* **Кодлоход хурдан**: Ямар нэгэн шинэ зүйл хөгжүүлэх хурдыг 200-гаас 300% нэмэгдүүлнэ. *
* **Bug багатай**: Ойролцоогоор хүний (инженерийн) гаргадаг алдааг 40%-иар бууруулна. *
* **Тохиромжтой**: Код эдитэрийн дэмжлэг сайтай. Код эдитэрийн <abbr title="Өөрөөр: auto-complete, autocompletion, IntelliSense">зөвлөгөө</abbr> маш их тул алдааг засахад зарцуулах хугацаа бага.
...
* **Стандартанд нийцсэн**: API-ийн стандартанд нийцсэн, бас түүн дээр суурилсан: <a href="https://github.com/OAI/OpenAPI-Specification" class="external-link" target="_blank">OpenAPI</a> (Өмнө нь Swagger гэж нэрлэгддэг байсан), <a href="https://json-schema.org/" class="external-link" target="_blank">JSON Schema</a>.

<small>* Борлуулалтанд зориулагдсан програмууд хөгжүүлэх явцад хийгдсэн туршилтуудад үндэслэв.</small>
...
"_**Netflix** нь **эрсдэлийн менежмент** фремворк буюу **Dispatch**-ийг нээлттэй эх сурвалжтайгаар гаргаснаа зарлаж байгаадаа баяртай байна! [**FastAPI**-ээр бүтээсэн]_"
...
"_Яг үнэнийг хэлэхэд та бүхэний бүтээсэн зүйл чинь маш бат бөх, төгс харагдаж байна. **Hug**-ийг яг ийм байгаасай гэж төсөөлж байсан. Хэн нэг нь үүнийг бүтээж байгааг харахад урам орч байна._"
