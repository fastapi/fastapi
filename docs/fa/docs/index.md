...
- **<abbr title="Fast">سرعت</abbr>**: کارایی بسیار بالا و قابل مقایسه با **Node.JS** و **Go** (با تشکر از Starlette و Pydantic). [یکی از سریع‌ترین فریم‌ورک‌های پایتونی موجود](#_10).
