...
همه اینها برپایه **<abbr title="type declaration">Type Hint</abbr> استاندارد پایتون ۳.۶** (به لطف Pydantic) میباشد. سینتکس جدیدی درکار نیست. تنها پایتون مدرن استاندارد.
