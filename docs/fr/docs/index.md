...
<p align="center">
    <em>FastAPI framework,haute performance, facile à apprendre, rapide à coder, prêt pour la production</em>
</p>
<p align="center">
...
FastAPI est un framework Web moderne, rapide (hautes performances) pour la création d'API avec Python 3.6+ basé sur des astuces de type Python standard.
...
* <a href="https://github.com/JoshData/python-email-validator" target="_blank"><code>email_validator</code></a> - por la validation par e-mail.
