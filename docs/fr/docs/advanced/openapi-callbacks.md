...
En implémentant vous-même le callback, vous pourriez utiliser quelque chose comme [HTTPX2](https://pydantic.dev/docs/httpx2/) ou [Requests](https://requests.readthedocs.io/).
