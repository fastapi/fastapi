...
Их **вложенность** может быть любого размера.

**FastAPI** позаботится об их управлении.

## Первая зависимость

Вы можете создать первую зависимость следующим образом:
...
Это довольно просто (не очень полезно), но поможет нам сосредоточиться на том, как работают подзависимости.
...
!!! tip "Подсказка"
    ...
    Но вы увидите, насколько это полезно, в главах, посвященных безопасности.
