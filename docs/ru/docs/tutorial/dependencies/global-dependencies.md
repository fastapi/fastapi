...
Подобно тому, как вы можете [добавлять параметр зависимостей `dependencies` к *декораторам операций пути*](dependencies-in-path-operation-decorators.md){.internal-link target=_blank}, вы можете добавлять их в `FastAPI` приложении.
