...
!!! check "Проверка"
    ...
    Обратите внимание, вы не создаёте специальный класс и не передаёте его куда то в **FastAPI** чтобы зарегистрировать его, или что-то в этом духе.
...
Вы можете описывать зависимости в очередь, а они уже вызовут друг-друга.
