...
Вы можете подписаться на (редкую) [новостную рассылку **FastAPI и друзья**](https://fastapi.tiangolo.com/newsletter/), чтобы быть в курсе:
...
Если вы помогаете многим людям с их вопросами, вы станете официальным [Экспертом FastAPI](https://fastapi.tiangolo.com/fastapi-people/#fastapi-experts). 🎉
