...
Я не смог использовать его в полноценном проекте, так как в нём были проблемы с безопасными интеграциями, из-за которых я не мог вставить все функции, которые у меня были в полноценных генераторах проектов на основе Flask-apispec.
