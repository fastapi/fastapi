...
Вы увидите намного больше всего этого на практике в [Руководстве пользователя](index.md){.internal-link target=_blank}.
...
Всё это может показаться абстрактным. Не волнуйтесь. Вы увидите всё это в действии в [Руководстве пользователя](index.md){.internal-link target=_blank}.
