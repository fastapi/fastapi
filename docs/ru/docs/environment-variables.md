...
Так же существует возможность создания переменных окружения **вне** Python, в терминале (или любым другим способом), а затем **читать их в Python**.
...
Эта информация будет полезна при изучении [Виртуального окружения](virtual-environments.md){.internal-link target=_blank}.
...
Подробнее о них вы также можете прочитать в <a href="https://en.wikipedia.org/wiki/Environment_variable" class="external-link" target="_blank">Википедии о переменных окружения</a>.
...
Например, эта информация понадобится вам в следующем разделе, посвященном [Вертуальным окружениям](virtual-environments.md).
