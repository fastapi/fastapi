...
- **Wydajność**: FastAPI jest bardzo wydajny, na równi z **Node.JS** oraz **Go** (dzięki Starlette i Pydantic). [Jeden z najszybszych dostępnych frameworków Pythonowych](#wydajnosc).
