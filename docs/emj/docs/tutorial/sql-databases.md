...
!!! tip
    📤 🛂 🏗 🚂 ⏮ **FastAPI** &amp; **✳**, 🌐 ⚓️ 🔛 **☁**, 🔌 🕸 &amp; 🌖 🧰: <a href="https://github.com/tiangolo/full-stack-fastapi-postgresql" class="external-link" target="_blank">https://github.com/tiangolo/full-stack-fastapi-postgresql</a>
...
!!! info "📡 ℹ"
    ...
    ✋️ FastAPI, ⚙️ 😐 🔢 (`def`) 🌅 🌘 1⃣ 🧵 💪 🔗 ⏮ 💽 🎏 📨, 👥 💪 ⚒ 🗄 💭 👈 ⚫️ 🔜 ✔ 👈 ⏮ `connect_args={"check_same_thread": False}`.
...
&amp; 🕐❔ 🔐 🔢 `owner` `Item`, ⚫️ 🔜 🔌 `User` 🇸🇲 🏷 ⚪️➡️ `users` 🏓. ⚫️ 🔜 ⚙️ `owner_id` 🔢/🏓 ⏮ 🚮 💱 🔑 💭 ❔ ⏺ 🤚 ⚪️➡️ `users` 🏓.
...
!!! tip
    👀 👈 `User`, Pydantic *🏷* 👈 🔜 ⚙️ 🕐❔ 👂 👩‍💻 (🛬 ⚫️ ⚪️➡️ 🛠) 🚫 🔌 `password`.
...
Pydantic `orm_mode` 🔜 💬 Pydantic *🏷* ✍ 💽 🚥 ⚫️ 🚫 `dict`, ✋️ 🐜 🏷 (⚖️ 🙆 🎏 ❌ 🎚 ⏮ 🔢).
...
✋️ ⏮ 🐜 📳, Pydantic ⚫️ 🔜 🔄 🔐 💽 ⚫️ 💪 ⚪️➡️ 🔢 (↩️ 🤔 `dict`), 👆 💪 📣 🎯 💽 👆 💚 📨 &amp; ⚫️ 🔜 💪 🚶 &amp; 🤚 ⚫️, ⚪️➡️ 🐜.
...
🗄 `Session` ⚪️➡️ `sqlalchemy.orm`, 👉 🔜 ✔ 👆 📣 🆎 `db` 🔢 &amp; ✔️ 👻 🆎 ✅ &amp; 🛠 👆 🔢.
...
!!! tip
    🏗 🔢 👈 🕴 💡 🔗 ⏮ 💽 (🤚 👩‍💻 ⚖️ 🏬) 🔬 👆 *➡ 🛠 🔢*, 👆 💪 🌖 💪 ♻ 👫 💗 🍕 &amp; 🚮 <abbr title="Automated tests, written in code, that check if another piece of code is working correctly.">⚒ 💯</abbr> 👫.
...
!!! tip
    ↩️ 🚶‍♀️ 🔠 🇨🇻 ❌ `Item` &amp; 👂 🔠 1⃣ 👫 ⚪️➡️ Pydantic *🏷*, 👥 🏭 `dict` ⏮ Pydantic *🏷*'Ⓜ 📊 ⏮:
...
🛎 👆 🔜 🎲 🔢 👆 💽 (✍ 🏓, ♒️) ⏮ <a href="https://alembic.sqlalchemy.org/en/latest/" class="external-link" target="_blank">⚗</a>.
...
👈, 👥 🔜 ✍ 🆕 🔗 ⏮ `yield`, 🔬 ⏭ 📄 🔃 [🔗 ⏮ `yield`](dependencies/dependencies-with-yield.md){.internal-link target=_blank}.
...
!!! info
    ...
    ✋️ 👆 💪 🚫 🤚 ➕1️⃣ ⚠ ⚪️➡️ 🚪 📟 (⏮ `yield`). 👀 🌖 [🔗 ⏮ `yield` &amp; `HTTPException`](./dependencies/dependencies-with-yield.md#dependencies-with-yield-and-httpexception){.internal-link target=_blank}
...
!!! info "📡 ℹ"
    🔢 `db` 🤙 🆎 `SessionLocal`, ✋️ 👉 🎓 (✍ ⏮ `sessionmaker()`) "🗳" 🇸🇲 `Session`,, 👨‍🎨 🚫 🤙 💭 ⚫️❔ 👩‍🔬 🚚.

    ✋️ 📣 🆎 `Session`, 👨‍🎨 🔜 💪 💭 💪 👩‍🔬 (`.add()`, `.query()`, `.commit()`, ♒️) &amp; 💪 🚚 👍 🐕‍🦺 (💖 🛠). 🆎 📄 🚫 📉 ☑ 🎚.
...
!!! tip
    ...
    ✋️ 🌐 *➡ 🛠* ✔️ `response_model` ⏮ Pydantic *🏷* / 🔗 ⚙️ `orm_mode`, 💽 📣 👆 Pydantic 🏷 🔜 ⚗ ⚪️➡️ 👫 &amp; 📨 👩‍💻, ⏮ 🌐 😐 ⛽ &amp; 🔬.

!!! tip
    👀 👈 📤 `response_models` 👈 ✔️ 🐩 🐆 🆎 💖 `List[schemas.Item]`.

    ✋️ 🎚/🔢 👈 `List` Pydantic *🏷* ⏮ `orm_mode`, 💽 🔜 🗃 &amp; 📨 👩‍💻 🛎, 🍵 ⚠.
...
↩️ 👥 ⚙️ 🇸🇲 🔗 &amp; 👥 🚫 🚚 🙆 😇 🔌-⚫️ 👷 ⏮ **FastAPI**, 👥 💪 🛠 💽 <abbr title="Automatically updating the database to have any new column we define in our models.">🛠</abbr> ⏮ <a href="https://alembic.sqlalchemy.org" class="external-link" target="_blank">⚗</a> 🔗.

&amp; 📟 🔗 🇸🇲 &amp; 🇸🇲 🏷 🖖 🎏 🔬 📁, 👆 🔜 💪 🎭 🛠 ⏮ ⚗ 🍵 ✔️ ❎ FastAPI, Pydantic, ⚖️ 🕳 🙆.

🎏 🌌, 👆 🔜 💪 ⚙️ 🎏 🇸🇲 🏷 &amp; 🚙 🎏 🍕 👆 📟 👈 🚫 🔗 **FastAPI**.

🖼, 🖥 📋 👨‍🏭 ⏮ <a href="https://docs.celeryq.dev" class="external-link" target="_blank">🥒</a>, <a href="https://python-rq.org/" class="external-link" target="_blank">🅿</a>, ⚖️ <a href="https://arq-docs.helpmanual.io/" class="external-link" target="_blank">📶</a>.
...
* 🛠 ✔️ `async` 🔢.
    * 🚥 📤 📟 ⚫️ 👈 ✔️ "⌛" 🕸, ⚫️ 💪 "🍫" 👆 🈸 📤 &amp; 📉 🎭 🍖.
    * 👐 ⚫️ 🎲 🚫 📶 ⚠ 📥 ⏮ 🌌 `SQLAlchemy` 👷.
    * ✋️ 🚥 👆 🚮 🌖 📟 🛠 👈 ✔️ 📚 <abbr title="input and output">👤/🅾</abbr> ⌛, ⚫️ 💪 ⤴ ⚠.
* 🛠 🏃 *🔠* 📨.
    * , 🔗 🔜 ✍ 🔠 📨.
    * 🕐❔ *➡ 🛠* 👈 🍵 👈 📨 🚫 💪 💽.
