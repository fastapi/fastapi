...
🥇, 🗄 `OAuth2PasswordRequestForm`, &amp; ⚙️ ⚫️ 🔗 ⏮ `Depends` *➡ 🛠* `/token`:
...
!!! tip
    Oauth2⃣ 🔌 🤙 *🚚* 🏑 `grant_type` ⏮ 🔧 💲 `password`, ✋️ `OAuth2PasswordRequestForm` 🚫 🛠 ⚫️.
...
!!! tip
    👐 🔗 🎓 `OAuth2PasswordRequestForm` 🏆 🚫 ✔️ 🔢 `scope` ⏮ 📏 🎻 👽 🚀, ↩️, ⚫️ 🔜 ✔️ `scopes` 🔢 ⏮ ☑ 📇 🎻 🔠 ↔ 📨.
...
!!! info
    🌅 🏁 🔑 `**👩‍💻_ #⃣ ` ✅ 🔙 [🧾 **➕ 🏷**](../extra-models.md#about-user_indict){.internal-link target=_blank}.
...
!!! tip
    ⏭ 📃, 👆 🔜 👀 🎰 🔐 🛠, ⏮ 🔐 #⃣ &amp; <abbr title="JSON Web Tokens">🥙</abbr> 🤝.
