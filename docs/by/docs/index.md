...
Калі вы не ведаеце, праверце раздзел _"Спяшаецеся?"_ пра  <a href="https://fastapi.tiangolo.com/async/#in-a-hurry" target="_blank">`async` і `await` у дакументацыі</a>.
...
Каманда `uvicorn main:app` мае наступны сэнс:
