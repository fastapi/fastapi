...
{* ../../docs_src/bigger_applications/app/routers/users.py hl[1,3] *}
...
{* ../../docs_src/bigger_applications/app/routers/users.py hl[6,11,16] *}
...
{* ../../docs_src/bigger_applications/app_an_py39/dependencies.py hl[3,6:8] *}
...
{* ../../docs_src/bigger_applications/app/routers/items.py hl[5:10,16,21] *}
...
{* ../../docs_src/bigger_applications/app/routers/items.py hl[3] *}
...
{* ../../docs_src/bigger_applications/app/routers/items.py hl[30:31] *}
...
{* ../../docs_src/bigger_applications/app/main.py hl[1,3,7] *}

### Den `APIRouter` importieren

Jetzt importieren wir die anderen Submodule, die `APIRouter` haben:

{* ../../docs_src/bigger_applications/app/main.py hl[4:5] *}
...
{* ../../docs_src/bigger_applications/app/internal/admin.py hl[3] *}
...
{* ../../docs_src/bigger_applications/app/main.py hl[14:17] *}
...
{* ../../docs_src/bigger_applications/app/main.py hl[21:23] *}
