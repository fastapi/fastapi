...
* **Einfach**: Entworfen, um einfach zu benutzen und zu erlernen zu sein. Weniger Zeit für das Lesen der Dokumentation.
...
Wenn Sie eine <abbr title="Command Line Interface – Kommandozeilen-Schnittstelle">CLI</abbr>-Anwendung für das Terminal erstellen, anstelle einer Web-API, schauen Sie sich <a href="https://typer.tiangolo.com/ an. " class="external-link" target="_blank">**Typer**</a> an.
