...
* **Fast**: மிக அதிக performance, **NodeJS** மற்றும் **Go**க்கு சமமாக (Starlette மற்றும் Pydantic காரணமாக). [Python frameworks-லேயே மிக வேகமான ஒன்றாக](#performance).
...
* **Intuitive**: சிறந்த editor support, எல்லா இடங்களிலும் <dfn title="also known as auto-complete, autocompletion, IntelliSense">Completion</dfn>. debugging நேரம் குறையும்.
...
<small>* production applications உருவாக்கிய ஒரு internal development team செய்த tests அடிப்படையிலான மதிப்பீடு.</small>
...
"_[...] இந்த நாட்களில் **FastAPI** ஐ நான் மிகவும் அதிகமாக பயன்படுத்துகிறேன். [...] உண்மையிலேயே இதை என் team-னுடைய **ML services at Microsoft** எல்லாவற்றுக்கும் பயன்படுத்த திட்டமிட்டுள்ளேன். அதில் சில core **Windows** product-லேயே integrate ஆகிறது, சில **Office** products-லையும் ஆகிறது._"

<div style="text-align: right; margin-right: 10%;">Kabir Khan - <strong>Microsoft</strong> <a href="https://github.com/fastapi/fastapi/pull/26"><small>(ref)</small></a></div>

---

"_**predictions** பெற query செய்யக்கூடிய ஒரு **REST** server உருவாக்க **FastAPI** library-யை நாம் பயன்படுத்த தீர்மானித்தோம். [Ludwig காக]_"
...
"_உண்மையிலேயே, நீங்க build செய்தது மிகவும் solid ஆகவும் polished ஆகவும் உள்ளது. பல விதத்தில், **Hug** இப்படித்தான் இருக்கணும் என்று நான் நினைத்தது போலவே உள்ளது — இதை ஒருத்தர் build செய்தது பார்க்க மிகவும் inspiring ஆக உள்ளது._"
...
"_REST APIs உருவாக்க ஒரு **modern framework** கற்றுக்கணும்னு நினைச்சா, **FastAPI** ஐ பார்க்கவும் [...] இது வேகமானது, பயன்படுத்த எளிது, கற்றுக்கொள்ள எளிது [...]_"
...
"_production Python API build செய்ய நினைப்பவர்களுக்கு, **FastAPI** ஐ நான் strongly recommend செய்வேன். இது **beautifully designed**, **simple to use**, மற்றும் **highly scalable**. எங்களின் API first development strategy-ல இது ஒரு **key component** ஆகி, Virtual TAC Engineer போன்ற பல automations மற்றும் services-ஐ இயக்குது._"
...
2025 முடிவில் வெளியான [FastAPI mini documentary](https://www.youtube.com/watch?v=mpR8ngthqiE) ஒன்று இருக்கிறது; அதை online-ல பார்க்கலாம்:
...
web APIக்கு பதிலாக terminal-ல் பயன்படுத்த ஒரு <abbr title="Command Line Interface">CLI</abbr> app உருவாக்க விரும்பினால், [**Typer**](https://typer.tiangolo.com/) ஐ பார்க்கவும்.
...
[virtual environment](https://fastapi.tiangolo.com/virtual-environments/) ஒன்றை create செய்து activate செய்துவிட்டு, பிறகு FastAPI ஐ install செய்யுங்கள்:
...
தெரியலைன்னா, docs-ல இருக்கும் _"In a hurry?"_ section-ல [`async` மற்றும் `await`](https://fastapi.tiangolo.com/async/#in-a-hurry) பற்றி பார்க்கவும்.
...
`fastapi dev` command உங்க `main.py` file-ஐ automatic-ஆ படிச்சு, அதில் உள்ள **FastAPI** app-ஐ கண்டுபிடிச்சு, [Uvicorn](https://www.uvicorn.dev) பயன்படுத்தி server-ஐ start செய்யும்.
...
உங்க browser-ல [http://127.0.0.1:8000/items/5?q=somequery](http://127.0.0.1:8000/items/5?q=somequery) ஐ திறக்கவும்.
...
automatic interactive API documentation (இதை [Swagger UI](https://github.com/swagger-api/swagger-ui) வழங்குகிறது) உங்களுக்கு தெரியும்:
...
alternative automatic documentation (இதை [ReDoc](https://github.com/Rebilly/ReDoc) வழங்குகிறது) இங்கே தெரியும்:
...
* input data-வின் <dfn title="also known as: serialization, parsing, marshalling">Conversion</dfn>: network-ல இருந்து Python data/types-களாக மாற்றுவது. இவற்றிலிருந்து வாசிக்கிறது:
    * JSON.
    * Path parameters.
    * Query parameters.
    * Cookies.
    ...
    * Forms.
    * Files.
* output data-வின் <dfn title="also known as: serialization, parsing, marshalling">Conversion</dfn>: Python data/types-ல இருந்து network data (JSON ஆக) மாற்றுவது:
...
* `GET` requests காக `q` என்ற optional query parameter இருக்கிறதா என்று check செய்யும் (`http://127.0.0.1:8000/items/foo?q=somequery` போல).
...
இன்னும் நிறைய features உடன் ஒரு complete example காக <a href="https://fastapi.tiangolo.com/tutorial/">Tutorial - User Guide</a> பார்க்கவும்.
...
* மிகவும் powerful, பயன்படுத்த எளிதான **<dfn title="also known as components, resources, providers, services, injectables">Dependency Injection</dfn>** system.
...
[FastAPI Cloud](https://fastapicloud.com) க்கு உங்க FastAPI app-ஐ optional-ஆ deploy செய்யலாம்; இன்னும் join செய்யலன்னா waiting list-ல சேருங்க. 🚀
...
**[FastAPI Cloud](https://fastapicloud.com)**-ஐ **FastAPI**-யை உருவாக்கிய அதே author மற்றும் team தான் build செய்தாங்க.
...
Independent TechEmpower benchmarks-ல், Uvicorn-ல் ஓடும் **FastAPI** applications [Python frameworks-லேயே மிகவும் வேகமான ஒன்றாக](https://www.techempower.com/benchmarks/#section=test&runid=7464e520-0dc2-473d-bd34-dbdfd7e85911&hw=ph&test=query&l=zijzen-7) காட்டப்படுது; Starlette மற்றும் Uvicorn தங்களுக்குக் கீழே மட்டும் (FastAPI உள்ளே பயன்படுத்துவது). (*)
...
* [`python-multipart`](https://github.com/Kludex/python-multipart) - `request.form()` உடன் form <dfn title="converting the string that comes from an HTTP request into Python data">"parsing"</dfn> support வேணும்னா required.

FastAPI பயன்படுத்துவது:

* [`uvicorn`](https://www.uvicorn.dev) - உங்க application-ஐ load செய்து serve செய்யும் server காக. இதில் `uvicorn[standard]` அடங்கும்; அதில் high performance serving காக தேவையான சில dependencies (எ.கா. `uvloop`) இருக்கிறது.
* `fastapi-cli[standard]` - `fastapi` command வழங்க.
    * இதில் `fastapi-cloud-cli` அடங்கும்; இதனால் உங்க FastAPI application-ஐ [FastAPI Cloud](https://fastapicloud.com) க்கு deploy செய்யலாம்.
...
* [`pydantic-extra-types`](https://docs.pydantic.dev/latest/usage/types/extra_types/extra_types/) - Pydantic உடன் பயன்படுத்த extra types காக.
