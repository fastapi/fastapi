...
<a href="https://twitter.com/fastapi" class="external-link" target="_blank">Siga @fastapi no **X (Twitter)**</a> para receber as últimas notícias sobre o **FastAPI**. 🐦
...
* <a href="https://twitter.com/tiangolo" class="external-link" target="_blank">Me siga no **X (Twitter)**</a>.
    ...
    * Também é possivel <a href="https://twitter.com/fastapi" class="external-link" target="_blank">seguir o @fastapi no X (Twitter)</a> (uma conta aparte).
