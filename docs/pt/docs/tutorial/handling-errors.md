...
`RequestValidationError` é uma subclasse do <a href="https://docs.pydantic.dev/#error-handling" class="external-link" target="_blank">`ValidationError`</a> existente no Pydantic.
