...
Bir "şema", bir şeyin tanımı veya açıklamasıdır. Onu uygulayan kod değil, yalnızca soyut bir açıklama.
...
Ve tümü OpenAPI'ye dayalı düzinelerce alternatif vardır. **FastAPI** ile oluşturulmuş uygulamanıza bu alternatiflerden herhangi birini kolayca ekleyebilirsiniz.
...
Bir API geliştirirken, "path" kaynakları ve concernleri ayırmanın ana yöntemidir.
